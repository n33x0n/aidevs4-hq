...
import { solveMainTask, solveSecretTask, solveLLM } from '../../../tasks/firmware/solver';
  ...
  return createSSEStream(async (send) => {
    ...
    if (modelsScope !== 'main') {
      ...
      if (secretResult.flag) {
        ...
        saveFlag('firmware', secretResult.flag, 'secret');
    ...
    if (modelsScope !== 'secrets') {
      ...
      if (result.flag) {
        ...
        saveFlag('firmware', result.flag, 'main');
