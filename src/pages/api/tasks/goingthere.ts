...
import { solveMainTask, solveSecretTask, solveLLM } from '../../../tasks/goingthere/solver';
  ...
  return createSSEStream(async (send) => {
    ...
    if (modelsScope !== 'main') {
      ...
      if (secretResult.flag) {
        ...
        saveFlag('goingthere', secretResult.flag, 'secret');
    ...
    if (modelsScope !== 'secrets') {
      ...
      if (result.flag) {
        ...
        saveFlag('goingthere', result.flag, 'main');
