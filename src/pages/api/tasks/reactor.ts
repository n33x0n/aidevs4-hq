...
import { solveMainTask, solveSecretTask, solveLLM } from '../../../tasks/reactor/solver';
  ...
  return createSSEStream(async (send) => {
    ...
    if (modelsScope !== 'main') {
      ...
      if (secretResult.flag) {
        ...
        saveFlag('reactor', secretResult.flag, 'secret');
    ...
    if (modelsScope !== 'secrets') {
      ...
      if (result.flag) {
        ...
        saveFlag('reactor', result.flag, 'main');
