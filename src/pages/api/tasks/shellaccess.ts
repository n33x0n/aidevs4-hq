...
import { solveMainTask, solveSecretTask, solveLLM } from '../../../tasks/shellaccess/solver';
  ...
  return createSSEStream(async (send) => {
    ...
    if (modelsScope !== 'main') {
      ...
      if (secretResult.flag) {
        ...
        saveFlag('shellaccess', secretResult.flag, 'secret');
    ...
    if (modelsScope !== 'secrets') {
      ...
      if (result.flag) {
        ...
        saveFlag('shellaccess', result.flag, 'main');
