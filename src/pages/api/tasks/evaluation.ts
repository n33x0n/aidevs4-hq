...
import { solveMainTask, solveSecretTask, solveLLM } from '../../../tasks/evaluation/solver';
  ...
  return createSSEStream(async (send) => {
    ...
    if (modelsScope !== 'main') {
      ...
      if (secretResult.flag) {
        ...
        saveFlag('evaluation', secretResult.flag, 'secret');
    ...
    if (modelsScope !== 'secrets') {
      ...
      if (result.flag) {
        ...
        saveFlag('evaluation', result.flag, 'main');
