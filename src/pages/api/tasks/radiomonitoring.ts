...
import { solveMainTask, solveSecretTask, solveLLM } from '../../../tasks/radiomonitoring/solver';
  ...
  return createSSEStream(async (send) => {
    ...
    if (modelsScope !== 'main') {
      ...
      if (secretResult.flag) {
        ...
        saveFlag('radiomonitoring', secretResult.flag, 'secret');
    ...
    if (modelsScope !== 'secrets') {
      ...
      if (result.flag) {
        ...
        saveFlag('radiomonitoring', result.flag, 'main');
