...
import { solveMainTask, solveSecretTask, solveLLM } from '../../../tasks/phonecall/solver';
  ...
  return createSSEStream(async (send) => {
    ...
    if (modelsScope !== 'main') {
      ...
      if (secretResult.flag) {
        ...
        saveFlag('phonecall', secretResult.flag, 'secret');
    ...
    if (modelsScope !== 'secrets') {
      ...
      if (result.flag) {
        ...
        saveFlag('phonecall', result.flag, 'main');
