...
import { solveMainTask, solveSecretTask, solveLLM } from '../../../tasks/mailbox/solver';
  ...
  return createSSEStream(async (send) => {
    ...
    if (modelsScope !== 'main') {
      ...
      if (secretResult.flag) {
        ...
        saveFlag('mailbox', secretResult.flag, 'secret');
    ...
    if (modelsScope !== 'secrets') {
      ...
      if (result.flag) {
        ...
        saveFlag('mailbox', result.flag, 'main');
