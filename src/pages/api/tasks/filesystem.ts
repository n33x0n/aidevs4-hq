...
import { solveMainTask, solveSecretTask, solveLLM } from '../../../tasks/filesystem/solver';
  ...
  return createSSEStream(async (send) => {
    ...
    if (modelsScope !== 'main') {
      ...
      if (secretResult.flag) {
        ...
        saveFlag('filesystem', secretResult.flag, 'secret');
    ...
    if (modelsScope !== 'secrets') {
      ...
      if (result.flag) {
        ...
        saveFlag('filesystem', result.flag, 'main');
